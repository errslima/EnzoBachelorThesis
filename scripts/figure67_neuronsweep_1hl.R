...
source("./scripts/2021_07_28_torch_dropout_nn.R", local = T)
source("./scripts/2021_07_28_torch_dropout_pred.R", local = T)

error_fn_list <- array(NA, dim = list(29, 100, 100))
error_fp_list <- array(NA, dim = list(29, 100, 100))
error_acc_list <- array(NA, dim = list(29, 100, 100))
...
# Saving statistics
save(error_acc_list, file = "./data/2021_08_07_neuronsweep_acc_36_8_2d.rda")
save(error_fn_list, file = "./data/2021_08_07_neuronsweep_fn_36_8_2d.rda")
save(error_fp_list, file = "./data/2021_08_07_neuronsweep_fp_36_8_2d.rda")
