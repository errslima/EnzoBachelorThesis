...
source("./scripts/2021_07_28_torch_dropout_nn_3d.R", local = T)
source("./scripts/2021_07_28_torch_dropout_pred_3d.R", local = T)
...
# Saving statistics
save(error_acc_list, file = "./data/2021_08_06_neuronsweep_acc_36_8_3d.rda")
save(error_fn_list, file = "./data/2021_08_06_neuronsweep_fn_36_8_3d.rda")
save(error_fp_list, file = "./data/2021_08_06_neuronsweep_fp_36_8_3d.rda")
